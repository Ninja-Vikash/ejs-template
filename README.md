...
fs.mkdir('views', ()=>console.log("view directory has been created!"))
fs.mkdir('public', ()=>console.log("public directory has been created!"))
fs.mkdir('public/css', ()=>console.log("css directory has been created!"))
...
fs.writeFile("index.js", IndexJS1 , ()=>console.log("index.js has been deployed!"))
...
setTimeout(() => {
    fs.appendFile('index.js', IndexJS2, ()=>console.log("index.js is updated!"))
    fs.appendFile('index.js', IndexJS3, ()=>console.log("index.js is updated!"))
}, 900);
...
<head>
    ...
    <title>EJS Template Deployer</title>
...
fs.writeFile("views/index.ejs", IndexEJS1 , ()=>console.log("index.ejs has been deployed!"))
...
setTimeout(() => {
    fs.appendFile('views/index.ejs', IndexEJS2, ()=>console.log('index.ejs is updated!'))
}, 1000);

setTimeout(() => {
    fs.appendFile('views/index.ejs', IndexEJS3, ()=>console.log("index.ejs is updated!"))
}, 1100);
...
fs.writeFile("views/link.ejs", LinkEJS, ()=>console.log("link.ejs has been deployed!"))
...
fs.writeFile("public/css/index.css", IndexCSS, ()=>console.log("index.css has been created!"))
...
fs.writeFile("public/css/link.css", LinkCSS, ()=>console.log("link.css has been deployed!"))
...
fs.writeFile('public/code.svg', codeSVG, ()=>console.log("code.svg has been created!"))
fs.writeFile('public/ejs.svg', ejsSVG , ()=>console.log("ejs.svg has been created!"))
fs.writeFile('public/github.svg', githubSVG, ()=>console.log("github.svg has been created!"))
fs.writeFile('public/linkedin.svg', linkedinSVG, ()=>console.log("linkedin.svg has been created!"))
